...
export default async function DynamicPage({ params }: PageProps) {
  ...
  try {
    ...
    console.log('All available pages:', allPages.docs.map((p: any) => ({ title: p.title, slug: p.slug })));
    ...
    console.log('Page data:', { title: page.title, slug: page.slug, layoutBlocks: page.layout?.length || 0 });
